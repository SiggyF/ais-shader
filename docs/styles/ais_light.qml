    ...
    <colorrampshader maximumValue="100" labelPrecision="4" clip="0" classificationMode="1" minimumValue="0" colorRampType="INTERPOLATED">
     <colorramp type="gradient" name="[source]">
      <Option type="Map">
       ...
       <Option type="QString" name="stops" value="0.25;200,160,120,255,rgb:0.78,0.62,0.47,1;rgb;ccw:0.5;120,80,40,255,rgb:0.47,0.31,0.15,1;rgb;ccw:0.75;60,40,20,255,rgb:0.23,0.15,0.08,1;rgb;ccw"/>
      </Option>
     </colorramp>
     <item color="#ffffff" label="0.0000" alpha="0" value="0"/>
     <item color="#c8a078" label="25.0000" alpha="255" value="25"/>
     <item color="#785028" label="50.0000" alpha="255" value="50"/>
     <item color="#3c2814" label="75.0000" alpha="255" value="75"/>
     <item color="#000000" label="100.0000" alpha="255" value="100"/>
